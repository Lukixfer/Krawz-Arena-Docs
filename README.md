...
> _"A interseção perfeita entre RPG Tático, Geração de Arte por IA e Arquitetura de Ponta em Tempo Real. Não é apenas um jogo, é o próximo unicórnio do entretenimento digital."_
...
## 📚 Índice de Documentação (Public)

Explore os detalhes do projeto através dos nossos documentos dedicados:

- **[🎯 Visão Geral e Recursos (FEATURES.md)](FEATURES.md)**
- **[⚙️ Mecânicas de Jogo (GAME_MECHANICS.md)](GAME_MECHANICS.md)**
- **[📖 Referência de API (API_REFERENCE.md)](API_REFERENCE.md)**
- **[🏗️ Arquitetura e Engenharia (ARCHITECTURE.md)](ARCHITECTURE.md)**
- **[🗺️ Roadmap Estratégico (ROADMAP.md)](ROADMAP.md)**
- **[💎 Plano de Patrocínio e Negócios (SPONSORSHIP.md)](SPONSORSHIP.md)**

### Guias e Tutoriais (`/docs`)

- **[Instalação e Pré-requisitos](docs/installation/prerequisites.md)**
- **[Setup do Banco de Dados](DATABASE-SETUP.md)**
- **[Diretrizes de Desenvolvimento](docs/development/architecture-deep-dive.md)**
- **[Quick Start - Sua Primeira Batalha](docs/guides/quick-start.md)**

### Exemplos Básicos (`/examples`)

- **[Autenticação JWT (JavaScript)](examples/authentication/login_jwt.js)**
- **[Cliente WebSocket Simples](examples/websocket/connect_and_duel.js)**
- **[Requisição Leaderboard REST](examples/rest-api/get_leaderboard.js)**
...
- **Q3 2026: Consolidação do Core & Beta Fechado** 🟢 _(Em Andamento)_
...
Estamos prontos para demonstrações técnicas (_Tear-Downs_ de Arquitetura) e discussões de _Cap Table_.
